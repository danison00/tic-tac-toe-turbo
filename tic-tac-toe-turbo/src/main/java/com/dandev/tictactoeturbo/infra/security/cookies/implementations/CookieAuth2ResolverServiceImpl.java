...
@Service("cookieResolverOAuth2")
public class CookieAuth2ResolverServiceImpl implements CookieResolverService {


    @Override
    public HttpServletResponse addCookies(HttpServletResponse response, String token, UUID id) {

        Cookie cookie1 = new Cookie("opaque_token_access", token);
